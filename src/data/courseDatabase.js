...
export const COURSES = [
  ...
  // ── 인천 ──────────────────────────────────────────────────
  {
    name: '클럽72', location: '인천',
    courses: [
      { name: '하늘아웃',   pars: [4,4,3,5,4,4,3,4,5] },
      { name: '하늘인',     pars: [4,4,4,3,5,4,3,5,4] },
      { name: '오션아웃',   pars: [5,4,4,3,4,5,4,3,4] },
      { name: '오션인',     pars: [4,4,3,4,5,4,3,5,4] },
      { name: '레이크아웃', pars: [4,3,4,5,3,5,4,4,4] },
      { name: '레이크인',   pars: [4,4,3,5,4,4,3,5,4] },
      { name: '클래식아웃', pars: [4,3,4,4,3,4,4,5,4] },
      { name: '클래식인',   pars: [5,4,3,4,4,5,3,4,4] },
    ],
  },
  {
  ...
  // ── 전북 ──────────────────────────────────────────────────
  {
    name: '군산CC', location: '전북',
    courses: [
      { name: '토너먼트OUT', pars: [3,5,4,3,4,4,4,4,5] },
      { name: '토너먼트IN',  pars: [4,4,4,4,5,3,4,5,3] },
      { name: '전주',        pars: [4,5,4,3,4,4,3,4,5] },
      { name: '익산',        pars: [4,5,4,3,5,4,4,3,4] },
      { name: '김제',        pars: [6,4,4,4,3,4,3,5,4] },
      { name: '정읍',        pars: [4,4,3,7,4,3,4,3,4] },
      { name: '부안',        pars: [5,4,4,4,5,3,5,4,3] },
      { name: '남원',        pars: [5,5,4,3,4,4,4,3,4] },
    ],
    pairs: [
      ['토너먼트OUT', '토너먼트IN'],
      ['전주', '익산'],
  ...
  },
  {
    ...
    courses: [
      ...
      { name: '남코스', pars: [4,5,4,4,3,4,5,3,4] },
      { name: '동코스', pars: [4,4,5,3,4,4,3,5,4] },
    ],
  },
  {
